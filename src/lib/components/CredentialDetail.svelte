...
<div class="modal" role="dialog" aria-label="Credential details">
  <div class="modal-header">
    ...
    <div><h2 class="modal-title">{credential.label}</h2><span class="modal-badge" class:badge-pid={isPID} class:badge-qeaa={!isPID}>{credential.type}</span></div>
...
<style>
  ...
  .modal-badge { font-size: 0.6rem; font-weight: 600; padding: 0.2rem 0.5rem; border-radius: 8px; text-transform: uppercase; display: inline-block; margin-top: 0.15rem; }

...
const translations = {
  en: {
    ...
    'verify.polling': '🔍 Waiting for server verification…',
    'verify.polling_hint': 'The Verifier server is validating the presentation. This should complete in a few seconds.',
    'verify.server_notice': '🔗 Connected to OpenID4VP Verifier Server',
    'verify.error.server_timeout': 'Server verification timed out after 15s. The server may be unreachable. Try manual JSON input below.',
  ...
  de: {
    ...
    'verify.polling': '🔍 Warte auf Server-Verifikation…',
    'verify.polling_hint': 'Der Verifier-Server validiert die Präsentation. Dies sollte in wenigen Sekunden abgeschlossen sein.',
    'verify.server_notice': '🔗 Mit OpenID4VP Verifier Server verbunden',
    'verify.error.server_timeout': 'Server-Verifikation nach 15s abgebrochen. Der Server ist möglicherweise nicht erreichbar. Versuche die manuelle JSON-Eingabe unten.',
